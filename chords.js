...
window.CHORDS = {
  ...
  "C": {
    ...
    guitars: [
      ...
      { startFret:3, barre:{fret:3,fromString:1,toString:5}, strings:[
        {fret:-1,finger:null},{fret:3,finger:1},{fret:5,finger:3},
        {fret:5,finger:3},{fret:5,finger:3},{fret:3,finger:1}
      ]}
    ]
  },
  "D": {
    ...
    guitars: [
      ...
      { startFret:5, barre:{fret:5,fromString:1,toString:5}, strings:[
        ...
        {fret:7,finger:3},{fret:7,finger:3},{fret:5,finger:1}
      ]}
    ]
  },
  "E": {
    ...
    guitars: [
      ...
      { startFret:7, barre:{fret:7,fromString:1,toString:5}, strings:[
        ...
        {fret:9,finger:3},{fret:9,finger:3},{fret:7,finger:1}
      ]}
    ]
  },
  "F": {
    ...
    guitars: [
      ...
      { startFret:1, barre:{fret:1,fromString:4,toString:5}, strings:[
  ...
  "F7": {
    ...
    guitars: [{ startFret:1, barre:{fret:1,fromString:0,toString:5}, strings:[
      {fret:1,finger:1},{fret:1,finger:1},{fret:2,finger:2},
  ...
  "Cm7": {
    ...
    guitars: [{ startFret:3, barre:{fret:3,fromString:0,toString:5}, strings:[
  ...
  "Bm7": {
    notes: ["B","D","F#","A"], octaves: [2,3,3,4],
    guitars: [{ startFret:2, barre:{fret:2,fromString:0,toString:5}, strings:[
      {fret:2,finger:1},{fret:2,finger:1},{fret:4,finger:3},
